...
`tools/gen_pcb_smd.py`. **97.8 × 60.7 mm**, two layers, fully routed,
...
```
board 97.8 x 60.7 mm | 49 footprints | 132 pads | 155 tracks | 97 vias
board utilisation 65%; largest empty rectangle 5 x 38 mm at (93, 18)
...
| **…placement searched, board size derived from it** | **97.8 × 60.7 mm** | **97** |
...
it came out **the same area** — 5936 mm² against 5964 — differently
proportioned: 8.9 mm narrower, 4.8 mm taller, at 65 % utilisation. The
