...
`tools/gen_pcb_smd.py`. **94.2 × 66.3 mm**, two layers, fully routed,
...
```
board 94.2 x 66.3 mm | 49 footprints | 132 pads | 180 tracks | 119 vias
board utilisation 67%; largest empty rectangle 9 x 34 mm at (0, 5)
...
| **…placement searched, board size derived from it** | **94.2 × 66.3 mm** | **119** |
