...
`tools/gen_pcb_smd.py`. **76.2 × 61.0 mm**, two layers, fully routed,
...
```
board 76.2 x 61.0 mm | 44 footprints | 121 pads | 108 tracks | 43 vias
...
pairwise swaps scored on ratsnest length (912 → 837 mm).
