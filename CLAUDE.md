...
The committed board is **97.8 × 60.7 mm**, generated by the current
pipeline and verifying clean. It is the same area as the hand-placed board
it replaced (5936 mm² vs 5964); the gain is in method, not size.
